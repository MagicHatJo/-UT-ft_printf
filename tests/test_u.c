...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2019/05/24 20:43:58 by jochang           #+#    #+#             */
/*   Updated: 2019/05/24 20:43:59 by jochang          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static int	test_01(void)
{
	...
	if (!capture_init())
		return (0);
	libc_retval = printf("%u", 42);
	capture_get(libc_buf, BUF_SIZE);
	ft_retval = ft_printf("%u", 42);
...
static int	test_02(void)
{
	...
	if (!capture_init())
		return (0);
	libc_retval = printf("Kashim a %u histoires à raconter", 1001);
	capture_get(libc_buf, BUF_SIZE);
	ft_retval = ft_printf("Kashim a %u histoires à raconter", 1001);
	capture_get(ft_buf, BUF_SIZE);
	capture_close();
	result = !strcmp(libc_buf, ft_buf) ? 1 : 0;
	result &= libc_retval == ft_retval;
...
static int	test_03(void)
{
	...
	if (!capture_init())
		return (0);
	libc_retval = printf("Il fait au moins %u\n", -8000);
	capture_get(libc_buf, BUF_SIZE);
	ft_retval = ft_printf("Il fait au moins %u\n", -8000);
	capture_get(ft_buf, BUF_SIZE);
	capture_close();
	result = !strcmp(libc_buf, ft_buf) ? 1 : 0;
	result &= libc_retval == ft_retval;
...
static int	test_04(void)
{
	...
	if (!capture_init())
		return (0);
	libc_retval = printf("%u", -0);
	capture_get(libc_buf, BUF_SIZE);
	ft_retval = ft_printf("%u", -0);
	capture_get(ft_buf, BUF_SIZE);
	capture_close();
	result = !strcmp(libc_buf, ft_buf) ? 1 : 0;
	result &= libc_retval == ft_retval;
...
static int	test_06(void)
{
	...
	if (!capture_init())
		return (0);
	libc_retval = printf("%u", INT_MAX);
	capture_get(libc_buf, BUF_SIZE);
	ft_retval = ft_printf("%u", INT_MAX);
	capture_get(ft_buf, BUF_SIZE);
	capture_close();
	result = !strcmp(libc_buf, ft_buf) ? 1 : 0;
	result &= libc_retval == ft_retval;
...
static int	test_07(void)
{
	...
	if (!capture_init())
		return (0);
	libc_retval = printf("%u", INT_MIN);
	capture_get(libc_buf, BUF_SIZE);
	ft_retval = ft_printf("%u", INT_MIN);
	capture_get(ft_buf, BUF_SIZE);
	capture_close();
	result = !strcmp(libc_buf, ft_buf) ? 1 : 0;
	result &= libc_retval == ft_retval;
...
static int	test_08(void)
{
	...
	if (!capture_init())
		return (0);
	libc_retval = printf("%u", INT_MIN - 1);
	capture_get(libc_buf, BUF_SIZE);
	ft_retval = ft_printf("%u", INT_MIN - 1);
	capture_get(ft_buf, BUF_SIZE);
	capture_close();
	result = !strcmp(libc_buf, ft_buf) ? 1 : 0;
	result &= libc_retval == ft_retval;
...
static int	test_09(void)
{
	...
	if (!capture_init())
		return (0);
	libc_retval = printf("%u", INT_MAX + 1);
	capture_get(libc_buf, BUF_SIZE);
	ft_retval = ft_printf("%u", INT_MAX + 1);
	capture_get(ft_buf, BUF_SIZE);
	capture_close();
	result = !strcmp(libc_buf, ft_buf) ? 1 : 0;
	result &= libc_retval == ft_retval;
...
static int	test_10(void)
{
	...
	if (!capture_init())
		return (0);
	libc_retval = printf("%%u 0000042 == |%u|\n", 0000042);
	capture_get(libc_buf, BUF_SIZE);
	ft_retval = ft_printf("%%u 0000042 == |%u|\n", 0000042);
	capture_get(ft_buf, BUF_SIZE);
	capture_close();
	result = !strcmp(libc_buf, ft_buf) ? 1 : 0;
	result &= libc_retval == ft_retval;
...
static int	test_11(void)
{
	...
	if (!capture_init())
		return (0);
	libc_retval = printf("%%u \t == |%u|\n", '\t');
	capture_get(libc_buf, BUF_SIZE);
	ft_retval = ft_printf("%%u \t == |%u|\n", '\t');
	capture_get(ft_buf, BUF_SIZE);
	capture_close();
	result = !strcmp(libc_buf, ft_buf) ? 1 : 0;
	result &= libc_retval == ft_retval;
...
static int	test_12(void)
{
	...
	if (!capture_init())
		return (0);
	libc_retval = printf("%%u Lydie == |%u|\n", 'L' + 'y' + 'd' + 'i' + 'e');
	capture_get(libc_buf, BUF_SIZE);
	ft_retval = ft_printf("%%u Lydie == |%u|\n", 'L' + 'y' + 'd' + 'i' + 'e');
	capture_get(ft_buf, BUF_SIZE);
	capture_close();
	result = !strcmp(libc_buf, ft_buf) ? 1 : 0;
	result &= libc_retval == ft_retval;
